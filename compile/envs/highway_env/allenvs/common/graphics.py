...
from ....highway_env.allenvs.common.action import ActionType, DiscreteMetaAction, ContinuousAction
from ....highway_env.road.graphics import WorldSurface, RoadGraphics
from ....highway_env.vehicle.graphics import VehicleGraphics

if TYPE_CHECKING:
    from ....highway_env.allenvs import AbstractEnv
    from ....highway_env.allenvs.common.abstract import Action
...
class EnvViewer(object):
    ...
    def display(self) -> None:
        ...
        #show custom trajectory
        if self.config["show_cust_traj"]:
            RoadGraphics.display_custom_trajectory(
            surface=self.sim_surface,
            offscreen=self.offscreen,
            traj_list=self.config["cust_traj"])
