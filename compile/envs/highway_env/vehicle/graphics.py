...
class VehicleGraphics(object):
    ...
    GREEN = (50, 200, 0)
    BLUE = (100, 200, 255)
    YELLOW = (235, 189, 52)#(200, 200, 0)
    BLACK = (70, 70, 70)
    PURPLE = (200, 0, 150)
    STEERING_WHEEL = (36, 37, 59)
    ...
    def display(cls, vehicle: Vehicle, surface: "WorldSurface", transparent: bool = False, offscreen: bool = False,
        ...
        steering_center = (surface.pix(tire_length+4.75-headlight_length), surface.pix(length / 2))
        color = cls.YELLOW#cls.get_color(v, transparent)
        ...
        pygame.draw.circle(vehicle_surface, cls.STEERING_WHEEL, steering_center, 4, 2)
    ...
    def get_color(cls, vehicle: Vehicle, transparent: bool = False) -> Tuple[int]:
        ...
        if getattr(vehicle, "color", None):
            color = cls.YELLOW#vehicle.color
